...
<body>
    <main class="container flex items-center justify-center h-screen">
        ...
        ?>
        <article class="w-2/4 text-white bg-green-700 p-9 roundead">
            <p class="text-center">
        ...
        ?>
        <article class="w-2/4 text-white bg-orange-700 p-9 roundead">
            <ul>
        ...
        ?>
        <article class="w-2/4 text-white bg-red-700 p-9 roundead">
            <p class="text-center">
                <?= $_SESSION['msg_error'] ?>
            </p>
            <a class="underline" href="#" onclick="window.history.back()">Voltar</a>
